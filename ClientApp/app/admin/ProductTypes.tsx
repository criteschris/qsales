...
export const ManageProductTypes = () => {
    ...
    return (
        <Container>
            <h2>Manage the product types used by the application</h2>
            <p>Deleting a product type will remove all data related to it. Be aware that you will lose all historical data about this product type.</p>
            <div className='row'>
...
render(<ManageProductTypes />, document.getElementById('react-app'));